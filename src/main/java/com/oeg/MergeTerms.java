...
public class MergeTerms {
    ...
    private  HashMap<String,Boolean[]> nouns = new HashMap<String, Boolean[]>();
    private  ArrayList<String> text2onto = new ArrayList<String>();
    private  ArrayList<String> sketch = new ArrayList<String>();
    private  ArrayList<String> our = new ArrayList<String>();
